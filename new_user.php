					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Mahasiswa</option>
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Dosen</option>
						...
						<?php endif; ?>
						<div class="form-group">
							<label class="control-label">Learning</label>
